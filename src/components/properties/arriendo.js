...
export default ()=> {
  ...
  const getProperties = async ()=> {
    ...
    try{
      ...
      const params = location.search ? location.search : `?status=PUBLICADA,ARRENDADA,VENDIDA&limit=12&typeId=office&id=&propertyType=&operation=ARRIENDO&commune=&stringSearch=&priceMin=&priceMax=&value=&valueUf=&totalAreaFrom=&totalAreaTo=&bedrooms=&bathrooms=&currency=CLP`;
