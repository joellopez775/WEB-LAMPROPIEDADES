...
const Card1 = styled.div`
  ...
  flex-direction: column;
  align-items: center;
  height: 30%; /* Ajusta este valor según el espacio disponible en el contenedor padre */
  width: 70%;
  border: 6px solid transparent; /* Borde transparente por defecto */
...
const Info = styled.p`
  ...
  color: ${props => props.theme.primaryColor};
  font-weight: bold;
  line-height: 10rem; /* Ajusta este valor para aumentar la altura */
`;
